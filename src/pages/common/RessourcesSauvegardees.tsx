...
import { getRessourcesSauvegardees, getRessourcesSauvegardeesProfesseur, RessourceSauvegardee, RessourceMediatheque, TypeCategorieRessource } from '../../models';
...
const RessourcesSauvegardees: React.FC = () => {
  ...
  // Compter les ressources par catégorie (sans cours)
  const countsByCategory = useMemo(() => {
    ...
    ressourcesSauvegardees.forEach(ressource => {
      // Vérifier que la ressource existe et a une catégorie
      if (ressource && ressource.categorie && ressource.categorie in counts) {
  ...
  // Filtrage des ressources par onglet actif et recherche
  const filteredRessources = useMemo(() => {
    ...
    return filtered;
  }, [ressourcesSauvegardees, activeTab, searchQuery]);
