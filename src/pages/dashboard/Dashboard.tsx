...
import { getDashboardStats, mockMessages, mockTickets, mockEvenements, mockDocuments } from '../../data/mock/dashboard';
import { StatutDocument, TypeEvenement } from '../../types/dossier';
...
const Dashboard: React.FC = () => {
  ...
  const renderStatsCards = () => {
    ...
    // Cartes pour Professeur (sans rôles supplémentaires)
    if (user?.type === 'professeur' && !user?.estChef && !user?.estEncadrant && !user?.estJurie && !user?.estCommission) {
      cards.push(
        <DashboardCard 
          key="cours"
    ...
    // Cartes pour Encadrant (professeur avec rôle encadrant)
    ...
    // Cartes pour Jury (professeur avec rôle jurie)
    ...
    // Cartes pour Commission (professeur avec rôle commission)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                {user?.type === 'professeur' && !user?.estChef && !user?.estEncadrant && !user?.estJurie && !user?.estCommission && (
